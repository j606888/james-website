const CONTENT = [
  {
    title: "馬太網路 後台網站",
    description:
      "串接 Google Maps API 擷取指定區域的公司資訊，並透過第三方服務檢測 Email 健康狀況。同時導入 OpenAI API，實現多項智慧化功能，提升系統應用價值。",
    image: "/port-1.jpg",
  },
  {
    title: "晉弘實業 形象網站",
    description:
      "與設計師協作，從零打造傳統產業的企業形象網站。透過與業務部門的密切溝通，最終完成兼具專業企業形象與年輕活力元素的網站設計與開發。",
    image: "/port-2.jpg",
  },
  {
    title: "Danceloop",
    description:
      "一個專為舞蹈社群打造的影音平台。為避免 YouTube 的版權風險，自行實作影片上傳與串流功能，並設計可自訂的 篩選系統，提升課程與 Party 影片的檢索效率與使用體驗。",
    image: "/port-3.jpg",
  },
];
        ...
        <div className="flex flex-col gap-6 md:gap-10">
          ...
          <div className="flex flex-col gap-6">
            {CONTENT.map((item, index) => (
              ...
              >
                <div className=" rounded-[10px] md:w-[45%] overflow-hidden group">
                  <img
                    src={item.image}
                    alt={item.title}
                ...
                <div className="flex flex-col gap-4 md:py-3 md:pr-4 md:flex-1">
